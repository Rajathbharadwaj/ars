...
parser = argparse.ArgumentParser(description='Pass IPA')
parser.add_argument('--ipa', metavar='ipa', type=str, required=True)
...
if DEVICE == 'esp8266':
    UDP_IP = '10.10.10.'+args.ipa
    print('[INFO... ] Initializing ' + UDP_IP)
